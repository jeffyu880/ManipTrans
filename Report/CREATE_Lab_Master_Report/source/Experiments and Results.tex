...
The optimization-based retargeter outperforms the residual policy over the transport phases.
...
\begin{table}[H]
    ...
    \begin{tabular}{llccc}
        \toprule
        \textbf{Phase} & \textbf{Hand} & \shortstack{\textbf{Optimization-Based}\\\textbf{Retargeting}} & \textbf{Imitator} & \textbf{Residual (ours)} \\
        \midrule
