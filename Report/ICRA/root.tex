...
% ---- DOUBLE-ANONYMOUS SUBMISSION: this block is active for review ----
\author{Anonymous Author(s)}

% ---- CAMERA-READY: comment out the line above and uncomment this block ----
...
residual policy to each reference trajectory. Such a policy memorizes one kinematic
...
GPU-hours per sequence. A policy trained this way memorizes the specific kinematic path
...
(wrist frame) and velocity, $m_{\hat{o}}$ and $G_{\hat{o}}$ its center of mass and
...
its center, the left hand releases, and the right hand places it back into the cup ---
...
has a cost: demonstrations of differing object geometries and contact configurations may
induce conflicting gradients, causing the shared policy to converge to a compromise. Sensor noise also limits learning --- the AVP degrades under hand
...
% ---- CAMERA-READY: restore the funding/lab acknowledgment here ----
% The authors thank the CREATE Lab for supporting this work.

\textbf{Disclosure of AI use.} Claude (Anthropic) was used to condense the authors'
existing technical report into the text of this paper, across all sections, and to
format Tables~\ref{tab:offline}--\ref{tab:capablation}. The research, implementation,
experiments, and figures are the authors' own, and all resulting text was reviewed and
