...
import copy
import time
from optitrack_streamer import DataDescriptions
from optitrack_streamer import MoCapData
...
class NatNetClient:
    ...
    def __init__( self ):
        ...
        self.server_ip_address = "10.20.30.109"#"127.0.0.1"

        # Change this value to the IP address of your local network interface
        self.local_ip_address = "10.20.30.1"#"127.0.0.1"
