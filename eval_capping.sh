...
# CKPT=runs/capping_alcohol_burner_9_ALL_AUG_noise_0.4ma_loo_b5fa3@10__06-10-18-08-00/nn/last_capping_alcohol_burner_9_ALL_AUG_noise_0.4ma_loo_b5fa3@10_ep_600_rew_1776.5968_sr_0.3481481373310089_fr_0.6518517732620239.pth

# run_eval "0f900@10" "${CKPT}"
# run_eval "3b1e6@12" "${CKPT}"
# run_eval "85abe@4"  "${CKPT}"
# run_eval "8e5df@13" "${CKPT}"
# run_eval "a78a0@1"  "${CKPT}"
# run_eval "d6fe3@0"  "${CKPT}"
# run_eval "e49f5@0"  "${CKPT}"
# run_eval "f7d37@18" "${CKPT}"
# run_eval "b5fa3@10" "${CKPT}"
